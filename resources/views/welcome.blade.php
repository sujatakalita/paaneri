...
<div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:1600px;height:560px;overflow:hidden;visibility:hidden;">
    <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:1600px;height:480px;overflow:hidden;">
        ...
        @foreach(hero() as $key=>$home_page_slider)
        <div>
            <img data-u="image" data-src="{{ url('public/admin/hero/'.$home_page_slider->hero_img) }}" alt="Hero"/>
        </div>
        @endforeach
...
<section class="blog pt-3">
    <div class="container">
        <div class="row">
            ...
            <a href="{{ route('user.sale') }}"><img src="https://kalkifashion.com.imgeng.in/media/wysiwyg/1-best-seller-7-5-2022.jpg?imgeng=/w_264/h_311" class="img-fluid border rounded" alt=""></a>
            </div>
            @php
                $mega_menu_men = App\Models\Admin\MegaMenu::with('megaMenuCategory')->where([['status',1],['slug','men']])->first();
                $mega_menu_bridal = App\Models\Admin\MegaMenu::with('megaMenuCategory')->where([['status',1],['slug','bridal']])->first();
                $mega_menu_accessories = App\Models\Admin\MegaMenu::with('megaMenuCategory')->where([['status',1],['slug','accessories']])->first();
            @endphp

            <div class="col-md-3 col-6 p-2 text-center">
                <a href="{{ route('user.men',['mega_menu_men_slug' => $mega_menu_men->slug]) }}"><img src="https://kalkifashion.com.imgeng.in/media/wysiwyg/3-kalki-men-9-5-2022.jpg?imgeng=/w_264/h_311" class="img-fluid border rounded" alt=""></a>
            </div>
            

            <div class="col-md-3 col-6 p-2 text-center">
                <a href="{{ route('user.bridal',['mega_menu_bridal_slug' => $mega_menu_bridal->slug]) }}"><img src="https://kalkifashion.com.imgeng.in/media/wysiwyg/2-just-in-style-9-5-2022.jpg?imgeng=/w_264/h_311" class="img-fluid border rounded" alt=""></a>
            </div>
            
            <div class="col-md-3 col-6 p-2 text-center">
                <a href="{{ route('user.accessories',['mega_menu_accessories_slug' => $mega_menu_accessories->slug]) }}"><img src="https://kalkifashion.com.imgeng.in/media/wysiwyg/4-vedio-shoping-15-1-2022.webp?imgeng=/w_264/h_311" class="img-fluid border rounded" alt=""></a>
            </div>
        </div>
    </div>
</section><br>
                ...
                <div class="product-5 product-m no-arrow">
                    ...
                    <div class="product-box">
                        <div class="img-wrapper">
                            ...
                            @if($key==0)
                            <div class="front">
                                <a href="{{route('user.product.details',$product->slug)}}"><img src="{{ url('public/admin/images/product/'.$attachement->product_image_server_url) }}" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                            </div>
                            @endif
                            @if($key==1)
                            <div class="back">
                        ...
                        <div class="product-detail">
                            ...
                            <h4> <i class="fa fa-rupee"></i> 
                                @if($product->discount == 1)
                                    {{$product->discount_rate??'NA'}}
                                @elseif($product->discount == 0)
                                    {{$product->market_price??'NA'}}
                                @endif
                            </h4>
                        </div>
                    </div>
...
<div class="container">
    <div class="row">
        <div class="col">
            <div class="title1 section-t-space">
                <h3 class="title-inner1">SHOP BY OCCASION</h3>
            </div>
        </div>
    </div>
</div>
...
<section class="blog pt-0 ratio2_3">
    <div class="container">
        <div class="row product-occasion no-arrow">
            @foreach($cats as $cat)
                @foreach($cat->subCategory as $scat)

                    <div class="col-md-3 col-6 p-2 text-center">
                    <a href="{{ route('user.occasion',$scat->slug) }}"><img src="{{ url('public/admin/category/'.$scat->category_image) }}" class="img-fluid border rounded" alt="{{ ucwords($scat->name) }}"></a>
                    

                    {{-- <h4 style="margin-top: 10px;">{{$scat->name??'NA'}}</h4> --}}
                </div>
        ...
        <div class="row">
            <div class="col-md-12 mb-4">
                <div class="row">
                    ...
                    <div class="col-md-3 col-6 mt-2">
                        <img src="https://kalkifashion.com.imgeng.in/media/wysiwyg/me-5-7-5-2022.jpg?imgeng=/w_352/h_178" class="img-fluid rounded" alt="">
                    </div>
                    <div class="col-md-3 col-6 mt-2">
                        <img src="https://kalkifashion.com.imgeng.in/media/wysiwyg/me-3-7-5-2022.jpg?imgeng=/w_352/h_178" class="img-fluid rounded" alt="">
                    </div>
                    <div class="col-md-3 col-6 mt-2">
                        <img src="https://kalkifashion.com.imgeng.in/media/wysiwyg/me-1-13-4-2022.jpg?imgeng=/w_352/h_178" class="img-fluid rounded" alt="">
                    </div>
...
<div class="container">
    <div class="row">
        <div class="col">
            <div class="title1 section-t-space">
                <h3 class="title-inner1">SHOP BY STYLE</h3>
            </div>
        </div>
    </div>
</div>
...
<section class="blog pt-0 ratio2_3">
    <div class="container">
        <div class="row">
            @foreach($cats_styles as $cat)
                @foreach($cat->subCategory as $scat)
                 
                <div class="col-md-2 col-4 p-2 text-center">
                    <a href="{{ route('user.style',$scat->slug) }}"><img src="{{ url('public/admin/category/'.$scat->category_image) }}" class="img-fluid border rounded" alt="{{ ucwords($scat->name) }}"></a>
...
<section class="section-b-space pt-0 ratio_asos">
    <div class="container">
        <div class="row">
            <div class="col">
                <div class="product-5 product-m no-arrow">
                @if (is_array($best_for_men) || is_object($best_for_men))
                    @foreach($best_for_men as $key=>$product_cat)
                    
                    <div class="product-box">
                        <div class="img-wrapper">
                            @foreach($product_cat->product->productAttachment as $key=>$attachement)
...
<div class="container">
    <div class="row">
        <div class="col">
            <div class="title1 section-t-space">
                <h3 class="title-inner1">SHOP BY COLORS</h3>
            </div>
        </div>
    </div>
</div>
...
<section class="blog pt-0 ratio2_3">
    <div class="container">
        <div class="row">
            @foreach($cats_colors as $cat)
                @foreach($cat->subCategory as $scat)
                 
                <div class="col-md-2 col-4 p-2 text-center">
                    <a href="{{ route('user.color',$scat->slug) }}"><img src="{{ url('public/admin/category/'.$scat->category_image) }}" class="img-fluid border rounded" alt="{{ ucwords($scat->name) }}"></a>
