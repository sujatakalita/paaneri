    ...
    <div class="slide-1 home-slider">
        ...
        <div>
            <div class="home  text-center">
                <img src="{{$home_page_slider->slider_images}}" alt="" class="bg-img blur-up lazyload">
                <div class="container">
                    <div class="row">
                        <div class="col">
                            <div class="slider-contain">
                                <div>
                                    ...
                                    <a href="{{route('user.product')}}" class="btn btn-solid">shop now</a>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- blog section -->
<section class="blog pt-3 ratio2_3">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
