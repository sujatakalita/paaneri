                                            ...
                                            <div class="col-xl-3 col-6 col-grid-box">
                                                <div class="product-box">
                                                    <div class="img-wrapper">
                                                        ...
                                                        @if($key==0)
                                                        <div class="front">
                                                            <a href="{{route('user.product.details',$product->slug)}}"><img src="{{ url('public/admin/images/product/'.$product_attachment->product_image_server_url) }}" class="img-fluid blur-up lazyload bg-img" alt=""></a>
                                                        </div>
                                                        @endif
                                                        @if($key==1)
                                                        <div class="back">
                                                    ...
                                                    <div class="product-detail">
                                                        <div>
                                                            ...
                                                            <a href="product-page(no-sidebar).html">
                                                                <h6>{{ (\Illuminate\Support\Str::limit($product->title, $limit = 100, $end = '...')) }}</h6>
                                                            </a>
