                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 rtl-text">
                        <div class="product-right">
                            ...
                            <h3 class="price-detail">Rs.<span id="productPrice" style="font-size:28px!important;"></span></h3>
                            ...
                            <div class="product-buttons"><button type="submit" id="productByNowSubmitButton" class="btn btn-solid" style="width:250px;height:60px;" name="productsubmit" value="buynow"><i class="fa fa-bookmark fz-16 me-2" aria-hidden="true"></i>Buy Now</button> <button type="submit" class="btn btn-solid" style="width:250px;height:60px;"  name="productsubmit" value="addtocart"><i class="fa fa-bookmark fz-16 me-2" aria-hidden="true"></i>Add To Cart</button></div>
                            </form>
...
<script>
    ...
    // $('#orderOrAddProduct').on('submit', function(e) {
