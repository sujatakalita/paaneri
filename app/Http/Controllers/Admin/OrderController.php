        ...
        try {
            if ($status==2) {
                ...
                foreach($carts as $key=>$cart){
                 ...
                 Toastr::success('Order Place Successfully','success', ["positionClass" => "toast-top-right"]);
                 return redirect()->route('user.profile.view');
            } else {
                Toastr::error('Something want wrong!!Please Try again', '',["positionClass" => "toast-top-right"]);
